...
$(()=>{
	...
	$(".js-sort").on("change",function(e){
		(
			this.value==1 ? query({type:'product_sort',column:'date-create',dir:'DESC'}) :
			this.value==2 ? query({type:'product_sort',column:'date-create',dir:'ASC'}) :
